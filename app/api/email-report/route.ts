...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, ${whiteLabelConfig?.brandColor || '#10b981'} 0%, #059669 100%); padding: 30px; border-radius: 12px; margin-bottom: 30px;">
    <h1 style="color: white; margin: 0; font-size: 28px;">${whiteLabelConfig?.brandName || 'GME City'}</h1>
  ...
  <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center; color: #9ca3af; font-size: 12px;">
    <p>This report was generated by ${whiteLabelConfig?.brandName || 'GME City'} Local SEO Audit Tool</p>
    ...
    if (process.env.RESEND_API_KEY) {
      ...
      await resend.emails.send({
        from: 'GME City Reports <reports@gme.city>', // Update this to your verified domain
        to: emailTo,
